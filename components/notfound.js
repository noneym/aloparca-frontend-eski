...
const NotFound = ({ code }) => (
  <Layout meta={{ title: code + " Bulunamadı" }}>
    <Outer>
      <Container>
        <img src={"/static/" + code + ".svg"} alt={code} className="image" />
        <h1 className="title">Sayfa bulunamadı!</h1>
        <div className="text">
          Aradığınız sayfa değiştirilmiş ya da kaldırılmış olabilir.
        </div>
        <div className="buttons">
          ...
          <Link route="home" title="Anasayfa'ya dön">
            <span className="effect" />
